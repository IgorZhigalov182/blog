import {
  HTMLAttributeAnchorTarget, memo, ReactNode, type PropsWithChildren,
} from 'react';
...
const getSkeletons = (view: ArticleView): ReactNode => new Array(view === ArticleView.GRID ? 9 : 3)
  .fill(0)
...
export const ArticleList = memo((props: PropsWithChildren<ArticleListProps>) => {
  const {
    className, articles, view = ArticleView.GRID, isLoading, target,
  } = props;
