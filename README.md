...
используется собственный eslint plugin [_eslint-plugin-fsd-arch-path_](https://www.npmjs.com/package/eslint-plugin-fsd-arch-path),
...
На вход toggleFeatures принимает следующий набор атрибутов:
...
- [ProfileRaiting](/src/features/ProfileRaiting)
